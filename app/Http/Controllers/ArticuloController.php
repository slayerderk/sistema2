...
class ArticuloController extends Controller
{
    ...
    //este listarArticulo, pertenece al MODAL de Ingreso
    ...
    //este listarArticuloVenta, pertenece al MODAL de VENTA
    public function listarArticuloVenta(Request $request)
    {
        ...
        if ($buscar==''){
            $articulos = Articulo::join('categorias','articulos.idcategoria','=','categorias.id')
            ->select('articulos.id','articulos.idcategoria','articulos.codigo','articulos.nombre','categorias.nombre as nombre_categoria','articulos.precio_venta','articulos.stock','articulos.descripcion','articulos.condicion')
            //muestra solo articulos q existe en almacen
    ...
    public function listarPdf(){
        $articulos = Articulo::join('categorias','articulos.idcategoria','=','categorias.id')
            ...
            $cont=Articulo::count();    //almacena la cantidad de registros almacenados
