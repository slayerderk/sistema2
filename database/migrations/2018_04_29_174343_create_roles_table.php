...
class CreateRolesTable extends Migration
{
    ...
    public function up()
    {
        ...
        //envia valores a la tabla roles
        //es decir, cuando se crea la tabla, automaticamnete va tener estos valores ya registrados en la BD
        //DB::table('roles')->insert(array('id'=>'1','nombre'=>'Desarrollador', 'descripcion'=>'Administrador General'));
