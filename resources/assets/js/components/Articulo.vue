                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <select class="form-control col-md-3" v-model="criterio">
                                        <option value="codigo">Código</option>  <!--    nombre y descripcion son los CRITERIOS  -->
                                ...
                                <tbody>
                                    <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                        <td>
                                            ...
                                            <!-- muestra mensaje de Activar (si esta desactivado la categoria) -->
                                            <template v-else>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Código <span style="color:red;" v-show="codigo==0"> (*)</span></label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="codigo" class="form-control" placeholder="Código de barras"> 
                                        <barcode :value="codigo" :options="{ format: 'EAN-13' }">
                                            *Ingrese para generar código de barras.    
                                        </barcode>                                       
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Nombre<span style="color:red;" v-show="nombre==0"> (*)</span></label>
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de artículo">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Precio Venta <span style="color:red;" v-show="precio_venta==0"> (*)</span></label>
                                    <div class="col-md-9">
                                        <input type="number" v-model="precio_venta" class="form-control" placeholder="" min="0">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-3 form-control-label" for="text-input">Stock <span style="color:red;" v-show="stock==0"> (*)</span></label>
                                    <div class="col-md-9">
                                        <input type="number" v-model="stock" class="form-control" placeholder="" min="0">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <!--Error q se muestra si esta vacio el input categoria -->
...
<script>
    //se importa para q funcione Codigo de barras
    ...
    export default {
        data (){
            return {
                ...
                offset : 3,
                criterio : 'codigo',    //inicia con el texto (en el comboBox)
                buscar : '',
                arrayCategoria :[]
            }
        },
        ...
        methods : {
            listarArticulo (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayArticulo = respuesta.articulos.data;    //muestra todos los registros de la tabla categorias
            ...
            validarArticulo(){
                ...
                //Errores q te muestra si estan vacios o mal escrito los campos
