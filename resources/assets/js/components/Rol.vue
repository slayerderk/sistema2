<template>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <!--   muestra el boton NUEVO para agregar 
            ...
            <!-- LO desactivamos, el AGREGAR y ACTUALUALIZAR xq los roles van a ser estaticos 
    ...
    export default {
        data (){
            return {
                ...
                offset : 3,
                criterio : 'nombre',    //inicia con el texto
                buscar : ''
            }
        },
        computed:{
        ...
        methods : {
            listarRol (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayRol = respuesta.roles.data; //muestra todos los registros de la tabla categorias
