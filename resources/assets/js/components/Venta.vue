            ...
            <div class="container-fluid">
                ...
                <div class="card">
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="form-group row border">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input style="background:#E7F89B" type="number" value="0" class="form-control" v-model="descuento" min="0">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            ...
                                            <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                                ...
                                                <td>
                                                    <!-- Precio-->
                                                    <input v-model="detalle.precio" type="number" class="form-control" min="0">
                                                </td>
                                                <td>
                                                    <!-- Cantidad-->
                                                    <span style="color:red;" v-show="detalle.cantidad>detalle.stock">Stock disponible de: {{detalle.stock}}</span>
                                                    <input v-model="detalle.cantidad" type="number" class="form-control" min="0">
                                                </td>
                                                <td>
                                                    <!-- Descuento-->
                                                    <span style="color:red;" v-show="detalle.descuento>(detalle.precio*detalle.cantidad)">*El Descuento es Superior</span>
                                                    <input v-model="detalle.descuento" type="number" class="form-control" min="0">
                                                </td>
                                                <!-- Sub Total-->
                                                <td>
                                            ...
                                            <tr style="background-color: #CEECF5;">
                                                ...
                                                <td>S/ {{totalImpuesto=((total*impuesto)/(1+impuesto)).toFixed(2)}}</td>    <!-- toFixed, sirve para redondear-->  
                                            </tr>
                                            <tr style="background-color: #CEECF5;">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12" align="center">
                                    ...
                                    <button type="button" class="btn btn-warning" v-show="arrayDetalle==0" disabled>Registrar Venta</button>
                                    <button type="button" class="btn btn-warning" @click="registrarVenta()" v-show="arrayDetalle!=0"><b>Registrar Venta</b></button>
                                </div>
                            </div>
                        </div>
                    </template>
                    ...
                    <template v-else-if="listado==2">
                        <div class="card-body"><h5 class="box-title">Detalles de Venta</h5>
                            <!-- Cabecera -->
                            <div class="form-group row border">
                                <div class="col-md-9">
                                    <div class="form-group">
                                ...
                                <div class="table-responsive col-md-12">
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            ...
                                            <tr style="background-color: #CEECF5;">
                                                <td colspan="4" align="right"><strong>IGV Incliudo:</strong></td>
                                        ...
                                        <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                            <td >
                                                <!-- <div v-show="articulo.stock==0" v-if="articulo.condicion==0">
                                                    <button type="button" class="btn btn-danger btn-sm" disabled>Agotado </button> 
                                                </div>
                                                <div v-show="articulo.stock!=0" v-if="articulo.condicion!=0">
                                                ...
                                                <div v-show="articulo.condicion==0" v-if="articulo.stock!=0">
                                                    <button type="button" class="btn  btn-sm" disabled>Desactivado </button>
                                                </div> -->
                                                <div v-show="articulo.stock==0" v-if="articulo.condicion==0">
                                                ...
                                                <div v-show="articulo.stock==0" v-if="articulo.condicion!=0">
                                                   <button type="button" class="btn btn-danger btn-sm" disabled>Agotado                    
                                                    </button> 
                                                </div>      
                                                <div v-show="articulo.stock!=0" v-if="articulo.condicion!=0">
                                                   <button type="button" @click="agregarDetalleModal(articulo)" class="btn btn-success btn-sm">
                                            ...
                                            <td v-text="articulo.stock" v-else>
                                            </td>
                                            <td>
        ...
        methods : {
            listarVenta (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayVenta = respuesta.ventas.data;  //muestra todos los registros de la tabla categorias
            ...
            agregarDetalle(){
                ...
                if(me.idarticulo==0 || me.cantidad==0 || me.precio==0){
                    ...
                    if(me.encuentra(me.idarticulo)){
                        ...
                        //si la cantidad > stock
                        if(me.cantidad>me.stock){
                           swal({
                            type: 'error',
                            title: 'Error...',
                            text: 'La cantidad supera al stock disponible!',
                            })
                        } 
                        else{
            ...
            registrarVenta(){
                ...
                axios.post('/venta/registrar',{
                    ...
                    swal({                        
                        type: 'success',
                        title: 'Venta realizada con exito con éxito!',
            ...
            validarVenta(){
                ...
                //prohibe q se venda, cuando la Cantidad es superior al Stock 
            ...
            verVenta(id){
                ...
                //Obtener los datos de la Venta CABECERA
                var arrayVentaT=[];
                ...
                //Obtener los datos de los detalles VENTA
               ...
               swal({
                ...
                if (result.value) {
                    ...
                    axios.put('/venta/desactivar',{
                        ...
                        swal({
                            type: 'success',
                            title: 'La venta ha sido anulada con éxito!',
                            showConfirmButton: false,
                            timer: 2200
